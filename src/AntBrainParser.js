...
function parseAntBrain(code) {
	...
	function _parseInt(string) {
		return parseInt(_stripZeroes(string), 10);
	}

	// these functions evaluate a line and, if the line represents a valid 
